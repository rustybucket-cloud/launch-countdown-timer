...
I learned how to work with Dates in Javascript. I picked a random date, found the difference between dates, and used the date to run the count down.

I learned how to use SASS to organize CSS and use SASS variables for styling
